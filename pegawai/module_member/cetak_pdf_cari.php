...
include "../../main/connection.php";
	...
	$cari2       =  $_POST["cari2"];
	$tampil_mahasiswa = mysql_query("SELECT * FROM member 
                              WHERE id_member like '%$cari2%' or 
                               username like '%$cari2%' or
                               password like '%$cari2%' or
                               id_pelanggan like '%$cari2%' or
                               aktif like '%$cari2%' or
                               tanggal_daftar like '%$cari2%' or
                               langganan like '%$cari2%' or
                               kuota_main like '%$cari2%'");
