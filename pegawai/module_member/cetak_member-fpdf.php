...
// Nama Kolom Heading
$header = array('No', 'ID Pelanggan', 'id_member','username','password','aktif','tanggal_daftar','langganan','kuota_main');

// Data loading
$query="select id_member,username,password,id_pelanggan,aktif,tanggal_daftar,langganan,kuota_main from member";
