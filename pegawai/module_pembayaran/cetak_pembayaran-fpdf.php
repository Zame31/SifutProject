...
// Nama Kolom Heading
$header = array('No', 'Id Pembayaran', 'Kode Pesan','Tanggal Transfer','Bank','Nominal');

// Data loading
$query="select id_pembayaran,kode_pesan,tanggal_transfer,bank,nominal from pembayaran";
