...
// Nama Kolom Heading
$header = array('No', 'Kode Pesan', 'Tanggal Pesan','Status Pemesan','Id Lapang','id Waktu','Tarif','Status','Id Pelanggan');

// Data loading
$query="select kode_pesan,tanggal_pesan,status_pemesan,id_lapang,id_waktu,tarif,status,id_pelanggan from pemesanan";
